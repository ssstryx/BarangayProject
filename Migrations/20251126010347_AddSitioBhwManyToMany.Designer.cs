...
namespace BarangayProject.Migrations
{
    ...
    [Migration("20251126010347_AddSitioBhwManyToMany")]
    partial class AddSitioBhwManyToMany
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BarangayProject.Models.SitioBhw", b =>
                {
                    b.Property<int>("SitioId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BarangayProject.Models.SitioBhw", b =>
                {
                    b.HasOne("BarangayProject.Models.ApplicationUser", "Bhw")
                        .WithMany()
                        .HasForeignKey("BhwId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
